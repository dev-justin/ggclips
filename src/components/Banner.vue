<template>
  <div class="relative bg-purple-700">
    <div class="absolute inset-0">
      <img
        class="h-full w-full object-cover"
        src="https://images.pexels.com/photos/9072212/pexels-photo-9072212.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
        alt=""
      />
      <div
        class="absolute inset-0 bg-purple-700 mix-blend-multiply"
        aria-hidden="true"
      />
    </div>
